...
flowchart TD
    ...
    REVIEW --> CREATE["POST /rest/api/3/issue<br/>reporter (email lookup only) → else stays API user,<br/>name/email → Submitter / Submitter Email columns,<br/>duedate, urgency label · drop-and-retry on 400"]
